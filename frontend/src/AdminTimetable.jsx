...
export default function AdminTimetable() {
  ...
  const getLabSlots = () => {
    if (formData.year === "1st Year") {
      ...
      return [
        {
          label: "Morning Lab (10:00 - 1:00)",
          value: "morning",
          slots: ["10:00-11:00", "11:00-12:00", "12:00-1:00"],
        },
        {
          label: "Afternoon Lab (1:40 - 4:40)",
          value: "afternoon",
          slots: ["1:40-2:40", "2:40-3:40", "3:40-4:40"],
        },
      ];
    }
  };
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (formData.type === "Lab") {
        ...
        const labSlotInfo = getLabSlots().find(
